...
export function SupportHeader() {
  return (
    <div className="flex flex-col xl:flex-row gap-4 mb-6">
      ...
      {/* Profile Card */}
      <div className="bg-white p-5 rounded-2xl shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border border-slate-100 xl:w-[360px] shrink-0 flex flex-col justify-between">
      ...
      <div className="bg-white p-5 rounded-2xl shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border border-slate-100 flex-1 flex flex-col relative overflow-hidden">
        <div className="flex items-center justify-between mb-8">
          <h3 className="text-[14px] font-bold text-slate-800">กระบวนการดูแลช่วยเหลือ</h3>
          <button className="flex items-center gap-1.5 text-[11px] font-bold text-indigo-600 bg-indigo-50 hover:bg-indigo-100 px-3 py-1.5 rounded-lg transition-colors border border-indigo-100/50">
        ...
        <div className="overflow-x-auto no-scrollbar pb-4 -mx-2 px-2 md:-mx-8 md:px-8 mt-2">
          ...
          <div className="flex flex-col items-center relative z-10 w-24 text-center group cursor-pointer">
            ...
            <div className="text-[12px] font-bold text-slate-700 mb-0.5">1. คัดกรอง</div>
            <div className="text-[10px] text-slate-400">ค้นหาผู้คัดกรองนักเรียน</div>
          </div>
          ...
          <div className="flex flex-col items-center relative z-10 w-24 text-center group cursor-pointer">
            ...
            <div className="text-[12px] font-bold text-slate-700 mb-0.5">2. วิเคราะห์</div>
            <div className="text-[10px] text-slate-400">วิเคราะห์สาเหตุ</div>
          </div>
          ...
          <div className="flex flex-col items-center relative z-10 w-24 text-center group cursor-pointer">
            ...
            <div className="text-[12px] font-bold text-emerald-600 mb-0.5">3. วางแผน</div>
            <div className="text-[10px] text-emerald-500/70">วางแผนช่วยเหลือ</div>
          </div>
          ...
          <div className="flex flex-col items-center relative z-10 w-24 text-center group cursor-pointer opacity-50">
            ...
            <div className="text-[12px] font-bold text-slate-700 mb-0.5">4. ดำเนินการ</div>
            <div className="text-[10px] text-slate-400">ให้การช่วยเหลือ</div>
          </div>
          ...
          <div className="flex flex-col items-center relative z-10 w-24 text-center group cursor-pointer opacity-50">
            ...
            <div className="text-[12px] font-bold text-slate-700 mb-0.5">5. ติดตามผล</div>
            <div className="text-[10px] text-slate-400">ติดตามผลต่อเนื่อง</div>
          </div>
