  ...
  return (
    <div className="flex flex-col bg-slate-50 min-h-screen font-sans pb-20">
      ...
      <div className="flex items-center justify-between px-4 pt-6 pb-4 bg-white sticky top-0 z-20 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
        ...
        <span className="text-base font-bold text-slate-900">ผลการเรียน</span>
        <button className="flex items-center gap-1.5 text-blue-600 text-[13px] font-bold px-2 py-1 bg-blue-50 rounded-lg">
      ...
      <div className="bg-white px-5 pt-4 pb-0">
        <div className="flex items-center gap-4 mb-5">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-base font-bold text-slate-900 leading-tight mb-1">เด็กชายธนวัฒน์ ใจดี</h2>
          ...
          <div className="text-right flex flex-col items-end">
            <div className="text-[11px] font-medium text-slate-500 mb-0.5">เกรดเฉลี่ย (GPA)</div>
            <div className="flex items-center gap-1 mb-1">
              <span className="text-2xl font-bold text-[#4f46e5] leading-none">3.48</span>
            </div>
            ...
            <div className="text-[11px] font-medium text-slate-500">อันดับที่ 12 / 28 คน</div>
          </div>
        </div>

        {/* Tabs */}
        <div className="flex justify-between border-b border-slate-100 px-1 overflow-x-auto no-scrollbar">
          <button className="pb-3 px-2 text-[13px] font-bold text-[#4f46e5] border-b-2 border-[#4f46e5] whitespace-nowrap">ภาพรวม</button>
          <button className="pb-3 px-2 text-[13px] font-medium text-slate-500 whitespace-nowrap">รายวิชา</button>
          <button className="pb-3 px-2 text-[13px] font-medium text-slate-500 whitespace-nowrap">รายภาคเรียน</button>
          <button className="pb-3 px-2 text-[13px] font-medium text-slate-500 whitespace-nowrap">พัฒนาการ</button>
          <button className="pb-3 px-2 text-[13px] font-medium text-slate-500 whitespace-nowrap">เปรียบเทียบ</button>
        </div>
      </div>
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="flex gap-3">
          <div className="flex-1 bg-white border border-slate-200 rounded-xl px-3 py-2.5 flex items-center justify-between shadow-sm">
            <span className="text-[13px] font-bold text-slate-800">ภาคเรียนที่ 1/2567</span>
            <svg className="w-4 h-4 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
          </div>
          <button className="bg-white border border-slate-200 rounded-xl px-4 py-2.5 flex items-center justify-center gap-1.5 shadow-sm text-blue-600 font-bold text-[13px]">
        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          <div className="bg-white rounded-3xl p-5 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border border-slate-100 flex flex-col justify-between">
            <h3 className="text-[11px] font-bold text-slate-800 mb-4">เปรียบเทียบ GPA</h3>
            ...
            <div className="flex items-center gap-1.5 mt-5 bg-emerald-50 rounded-xl px-3 py-2 w-max border border-emerald-100">
              ...
              <div className="flex flex-col">
                <span className="text-[11px] font-bold text-emerald-600 leading-tight">เพิ่มขึ้น 0.13</span>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-white rounded-2xl p-4 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border border-slate-100 flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-blue-50 text-blue-500 flex items-center justify-center shrink-0">
              <Book className="w-5 h-5" />
            </div>
            <div className="flex flex-col">
              <span className="text-[10px] text-slate-500 font-bold mb-0.5">รวมรายวิชา</span>
              <span className="text-xl font-bold text-slate-800 leading-none mb-0.5">15</span>
              <span className="text-[9px] text-slate-400">รายวิชา</span>
            </div>
          </div>
          
          <div className="bg-white rounded-2xl p-4 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border border-emerald-100 flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-emerald-50 text-emerald-500 flex items-center justify-center shrink-0">
              <CheckCircle className="w-5 h-5" />
            </div>
            <div className="flex flex-col">
              <span className="text-[10px] text-slate-500 font-bold mb-0.5">ผ่านเกณฑ์</span>
              <span className="text-xl font-bold text-slate-800 leading-none mb-0.5">14</span>
              <span className="text-[9px] text-slate-400">รายวิชา</span>
            </div>
          </div>

          <div className="bg-white rounded-2xl p-4 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border border-red-100 flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-red-50 text-red-500 flex items-center justify-center shrink-0">
              <XCircle className="w-5 h-5" />
            </div>
            <div className="flex flex-col">
              <span className="text-[10px] text-slate-500 font-bold mb-0.5">ไม่ผ่านเกณฑ์</span>
              <span className="text-xl font-bold text-slate-800 leading-none mb-0.5">1</span>
              <span className="text-[9px] text-slate-400">รายวิชา</span>
            </div>
          </div>

          <div className="bg-white rounded-2xl p-4 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border border-purple-100 flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-purple-50 text-purple-500 flex items-center justify-center shrink-0">
              <GraduationCap className="w-5 h-5" />
            </div>
            <div className="flex flex-col">
              <span className="text-[10px] text-slate-500 font-bold mb-0.5">หน่วยกิตรวม</span>
              <span className="text-xl font-bold text-slate-800 leading-none mb-0.5">30</span>
        ...
        <div className="mt-6">
          <div className="flex items-center justify-between mb-4 px-1">
            <h3 className="text-sm font-bold text-slate-900">ผลการเรียนรายวิชา</h3>
          ...
          <div className="bg-white rounded-2xl shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border border-slate-100 overflow-hidden">
            <table className="w-full text-left">
              <thead>
                <tr className="bg-slate-50/80 border-b border-slate-100">
                  <th className="px-4 py-3 text-[10px] font-bold text-slate-500 w-[55%]">รายวิชา</th>
                  <th className="px-2 py-3 text-[10px] font-bold text-slate-500 text-center w-[15%]">หน่วยกิต</th>
                  <th className="px-2 py-3 text-[10px] font-bold text-slate-500 text-center w-[15%]">เกรด</th>
                  <th className="px-4 py-3 text-[10px] font-bold text-slate-500 text-right w-[15%]">คะแนน</th>
                </tr>
              </thead>
              <tbody>
                {subjects.map((subj, i) => (
                  <tr key={i} className="border-b border-slate-50 last:border-none">
                    <td className="px-4 py-3.5">
                      <div className="text-[12px] font-bold text-slate-800 leading-tight mb-1">{subj.name}</div>
                      <div className="text-[10px] text-slate-500">{subj.teacher}</div>
                    </td>
                    <td className="px-2 py-3.5 text-center text-[11px] font-bold text-slate-600">{subj.credits.toFixed(1)}</td>
                    <td className="px-2 py-3.5 text-center">
                      <span className={`inline-flex items-center justify-center w-6 h-6 rounded text-[11px] font-bold border ${getGradeColor(subj.grade)}`}>
                        {subj.grade}
                      </span>
                    </td>
                    <td className="px-4 py-3.5 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <span className="text-[12px] font-bold text-slate-800">{subj.score}</span>
            ...
            <button className="w-full py-4 text-[11px] font-bold text-blue-600 hover:bg-slate-50 flex items-center justify-center gap-1 border-t border-slate-50 transition-colors">
        ...
        <div className="mt-4 bg-white rounded-2xl shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border border-slate-100 p-4">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded bg-purple-50 flex items-center justify-center text-purple-600">
                <TrendingUp className="w-4 h-4" />
              </div>
              <h3 className="text-[13px] font-bold text-slate-800">พัฒนาการผลการเรียน</h3>
            </div>
            <button className="text-[11px] font-bold text-blue-600 border border-blue-100 rounded-lg px-2.5 py-1.5 hover:bg-blue-50">
              ดูพัฒนาการรายวิชา
            </button>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 divide-x divide-slate-100">
            <div className="flex flex-col items-center text-center">
              <span className="text-[10px] text-slate-500 font-bold mb-1">คะแนนเฉลี่ย</span>
              <span className="text-xl font-bold text-slate-800 mb-1">85.2%</span>
            ...
            <div className="flex flex-col items-center text-center">
              <span className="text-[10px] text-slate-500 font-bold mb-1">เกรดเฉลี่ย</span>
              <span className="text-xl font-bold text-slate-800 mb-1">3.48</span>
              <div className="flex items-center gap-1 text-[9px] font-bold text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded">
                <svg className="w-2.5 h-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 10l7-7m0 0l7 7m-7-7v18" /></svg>
                เพิ่มขึ้น 0.13
              </div>
            ...
            <div className="flex flex-col items-center text-center">
              <span className="text-[10px] text-slate-500 font-bold mb-1">อันดับในห้อง</span>
              <span className="text-xl font-bold text-slate-800 mb-1">12 / 28</span>
              <div className="flex items-center gap-1 text-[9px] font-bold text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded">
                <svg className="w-2.5 h-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 10l7-7m0 0l7 7m-7-7v18" /></svg>
                ดีขึ้น 4 อันดับ
              </div>
