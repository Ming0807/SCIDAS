...
export function MobileRiskSpiderChart() {
  return (
    <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-sm flex flex-col h-full">
      <h3 className="text-sm font-bold text-slate-800 mb-6">ปัจจัยความเสี่ยง 5 ด้าน</h3>
      ...
      <div className="flex-1 flex items-center justify-center relative mb-6">
        ...
        <div className="relative w-[200px] h-[200px]">
          ...
          <div className="absolute -top-4 left-[50%] -translate-x-[50%] flex flex-col items-center">
            ...
            <span className="text-xs font-bold text-slate-700">การมาเรียน</span>
            <span className="text-xs font-bold text-slate-900">85<span className="text-[10px] text-muted-foreground">/ 100</span></span>
          </div>
          ...
          <div className="absolute top-[30%] -right-8 flex flex-col items-center">
            ...
            <span className="text-xs font-bold text-slate-700">ผลการเรียน</span>
            <span className="text-xs font-bold text-slate-900">70<span className="text-[10px] text-muted-foreground">/ 100</span></span>
          </div>
          ...
          <div className="absolute bottom-2 -right-2 flex flex-col items-center">
            ...
            <span className="text-xs font-bold text-slate-700">พฤติกรรม</span>
            <span className="text-xs font-bold text-slate-900">60<span className="text-[10px] text-muted-foreground">/ 100</span></span>
          </div>
          ...
          <div className="absolute bottom-2 -left-6 flex flex-col items-center">
            ...
            <span className="text-xs font-bold text-slate-700">สภาพอารมณ์</span>
            <span className="text-xs font-bold text-slate-900">65<span className="text-[10px] text-muted-foreground">/ 100</span></span>
          </div>
          ...
          <div className="absolute top-[35%] -left-10 flex flex-col items-center">
            ...
            <span className="text-xs font-bold text-slate-700">สภาพครอบครัว</span>
            <span className="text-xs font-bold text-slate-900">90<span className="text-[10px] text-muted-foreground">/ 100</span></span>
          </div>
      ...
      <div className="flex items-center justify-center gap-6 mt-auto">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs font-bold text-slate-700">นักเรียนคนนี้</span>
        </div>
        <div className="flex items-center gap-1.5">
          <div className="w-4 h-0.5 bg-slate-400 border border-dashed border-slate-400"></div>
          <span className="text-xs text-slate-500 font-medium">ค่าเฉลี่ยระดับชั้น</span>
        </div>
      </div>
    </div>
  )
