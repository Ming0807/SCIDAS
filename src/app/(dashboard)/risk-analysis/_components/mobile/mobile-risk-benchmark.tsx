    ...
    <div className="bg-white rounded-2xl p-5 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border border-slate-100">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center gap-3">
          <span className="text-[11px] font-medium text-slate-700 w-24 shrink-0">นักเรียนคนนี้</span>
          ...
          <span className="text-[11px] font-bold text-slate-800 w-6 text-right">78</span>
        </div>

        <div className="flex items-center gap-3">
          <span className="text-[11px] font-medium text-slate-600 w-24 shrink-0">ค่าเฉลี่ยระดับชั้น ม.2</span>
          <div className="flex-1 h-2.5 bg-slate-100 rounded-full overflow-hidden flex items-center relative">
            <div className="h-full bg-yellow-400 rounded-full" style={{ width: '45%' }}></div>
          </div>
          <span className="text-[11px] font-bold text-slate-600 w-6 text-right">45</span>
        </div>

        <div className="flex items-center gap-3">
          <span className="text-[11px] font-medium text-slate-600 w-24 shrink-0">ค่าเฉลี่ยโรงเรียน</span>
          <div className="flex-1 h-2.5 bg-slate-100 rounded-full overflow-hidden flex items-center relative">
            <div className="h-full bg-green-500 rounded-full" style={{ width: '32%' }}></div>
          </div>
          <span className="text-[11px] font-bold text-slate-600 w-6 text-right">32</span>
        </div>

        <div className="flex items-center gap-3 relative pt-2 border-t border-slate-50 mt-1">
          <span className="text-[10px] text-slate-500 w-24 shrink-0">เกณฑ์เฝ้าระวัง (60)</span>
          ...
          <span className="text-[10px] text-slate-500 w-6 text-right">60</span>
        </div>
