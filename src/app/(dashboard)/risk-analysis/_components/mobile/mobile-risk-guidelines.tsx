...
export function MobileRiskGuidelines() {
  return (
    <div className="px-4 mb-6">
      <h3 className="text-[13px] font-bold text-slate-800 mb-4">แนวทางการช่วยเหลือที่แนะนำ</h3>
      ...
      <div className="flex overflow-x-auto gap-3 pb-4 no-scrollbar -mx-4 px-4">
        ...
        <div className="bg-red-50/80 rounded-2xl p-4 border border-red-100 shrink-0 w-[150px] flex flex-col justify-between group cursor-pointer hover:bg-red-100 transition-colors">
          ...
          <div className="flex flex-col">
            <h4 className="text-[13px] font-bold text-red-700 mb-1 leading-tight">1. เฝ้าระวังใกล้ชิด</h4>
            <p className="text-[10px] text-red-600/80 leading-snug">ติดตามการมาเรียน<br/>อย่างต่อเนื่อง</p>
          </div>
        ...
        <div className="bg-orange-50/80 rounded-2xl p-4 border border-orange-100 shrink-0 w-[150px] flex flex-col justify-between group cursor-pointer hover:bg-orange-100 transition-colors">
          ...
          <div className="flex flex-col">
            <h4 className="text-[13px] font-bold text-orange-700 mb-1 leading-tight">2. พูดคุยให้คำปรึกษา</h4>
            <p className="text-[10px] text-orange-600/80 leading-snug">นัดพูดคุยกับนักเรียน<br/>และผู้ปกครอง</p>
          </div>
        ...
        <div className="bg-green-50/80 rounded-2xl p-4 border border-green-100 shrink-0 w-[150px] flex flex-col justify-between group cursor-pointer hover:bg-green-100 transition-colors">
          ...
          <div className="flex flex-col">
            <h4 className="text-[13px] font-bold text-green-700 mb-1 leading-tight">3. วางแผนการช่วยเหลือ</h4>
            <p className="text-[10px] text-green-600/80 leading-snug">จัดทำแผนพัฒนารายบุคคล<br/>และติดตามผล</p>
          </div>
        ...
        <div className="bg-blue-50/80 rounded-2xl p-4 border border-blue-100 shrink-0 w-[150px] flex flex-col justify-between group cursor-pointer hover:bg-blue-100 transition-colors">
          ...
          <div className="flex flex-col">
            <h4 className="text-[13px] font-bold text-blue-700 mb-1 leading-tight">4. ติดตามและประเมินผล</h4>
            <p className="text-[10px] text-blue-600/80 leading-snug">ประเมินผลทุก<br/>2 สัปดาห์</p>
          </div>
