...
export function RiskMatrix() {
  return (
    <div className="bg-white rounded-2xl p-5 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border border-slate-100 flex-1 flex flex-col xl:flex-row gap-6 xl:items-stretch min-w-0">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex relative mt-4 ml-10">
          ...
          <div className="absolute -left-10 top-0 bottom-6 flex flex-col justify-between py-4 w-16 items-start">
            <span className="text-[11px] font-bold text-slate-600 mb-2 -ml-2 whitespace-nowrap">ผลกระทบ</span>
            <span className="text-[10px] text-slate-500">5 สูงมาก</span>
            <span className="text-[10px] text-slate-500">4 สูง</span>
            <span className="text-[10px] text-slate-500">3 ปานกลาง</span>
            <span className="text-[10px] text-slate-500">2 น้อย</span>
            <span className="text-[10px] text-slate-500">1 น้อยมาก</span>
          </div>
          ...
          <div className="flex-1 ml-8">
            ...
            <div className="flex justify-between mt-2 pt-1 text-center font-medium">
              <div className="flex-1 text-[10px] text-slate-500">1 น้อยมาก</div>
              <div className="flex-1 text-[10px] text-slate-500">2 น้อย</div>
              <div className="flex-1 text-[10px] text-slate-500">3 ปานกลาง</div>
              <div className="flex-1 text-[10px] text-slate-500">4 สูง</div>
              <div className="flex-1 text-[10px] text-slate-500">5 สูงมาก</div>
            </div>
            <div className="text-center mt-2 text-[11px] font-bold text-slate-600">โอกาสที่จะเกิด</div>
          </div>
        </div>
      </div>
      ...
      <div className="xl:w-[220px] shrink-0 flex flex-col mt-6 xl:mt-0 justify-between">
        ...
        <div className="bg-slate-50/50 rounded-xl p-4 border border-slate-100 h-full flex flex-col">
          <h4 className="text-[12px] font-bold text-slate-700 mb-4">ระดับความเสี่ยง</h4>
          
          <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="w-2.5 h-2.5 rounded-full bg-red-500"></div>
                <span className="text-[11px] font-bold text-slate-700">เสี่ยงสูง (16-25)</span>
              </div>
              <span className="text-[11px] font-bold text-slate-800">38 คน</span>
            </div>

            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="w-2.5 h-2.5 rounded-full bg-yellow-400"></div>
                <span className="text-[11px] font-medium text-slate-600">เสี่ยงปานกลาง (8-14)</span>
              </div>
              <span className="text-[11px] font-bold text-slate-800">112 คน</span>
            </div>

            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="w-2.5 h-2.5 rounded-full bg-green-500"></div>
                <span className="text-[11px] font-medium text-slate-600">เสี่ยงต่ำ (1-7)</span>
              </div>
              <span className="text-[11px] font-bold text-slate-800">492 คน</span>
            </div>
          </div>

          <div className="mt-auto pt-4 border-t border-slate-200">
            <div className="text-[10px] text-slate-400 font-medium mb-2">เกณฑ์การประเมิน</div>
            <div className="text-[9px] text-slate-500 mb-3 leading-relaxed">พิจารณาจาก โอกาสที่จะเกิด × ผลกระทบ</div>
            <button className="w-full py-1.5 px-3 bg-white border border-indigo-100 rounded-lg text-[10px] font-bold text-indigo-600 hover:bg-indigo-50 transition-colors flex items-center justify-center gap-1.5 shadow-sm">
              ดูเกณฑ์การประเมิน
