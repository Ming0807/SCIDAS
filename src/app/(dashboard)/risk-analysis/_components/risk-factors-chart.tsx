  ...
  return (
    <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-sm flex flex-col xl:flex-row gap-6 min-w-0">
      <div className="flex-1 flex flex-col h-full relative pb-4 min-w-0">
        <h3 className="text-sm font-bold text-slate-800 mb-6">ปัจจัยเสี่ยงที่พบ</h3>
        ...
        <div className="flex items-center justify-center flex-1 relative mb-4">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <span className="text-xs text-slate-500 font-medium">สัดส่วนปัจจัยเสี่ยง</span>
          </div>
        </div>

        <div className="text-xs text-slate-400 font-medium text-center absolute bottom-0 left-0 right-0">
