        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <div className="flex items-center gap-2 text-[13px] text-slate-500 mt-1">
              ...
              <span className="font-bold text-slate-800">รายงาน</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="flex items-center gap-2 bg-white border border-slate-200 rounded-xl px-4 py-2 text-[13px] font-bold text-indigo-600 hover:bg-indigo-50 transition-colors shadow-sm">
